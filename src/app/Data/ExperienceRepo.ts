...
export class ExperienceRepo{
    experienceInfo : Array<Experience> = [
        ...
        description: "I work as a flutter software developer in an agile team of 12, using Bitbucket and Jira for efficient collaboration and development. My focus is crafting responsive and innovative mobile applications using Flutter.",
        ...
        description: "I was a Full Stack developer who worked in an agile work environment alongside a dynamic team of 10 developers. I have proactively immersed myself in practical learning experiences, gaining expertise in cutting-edge technologies such as .NET, Angular, React, Azure, and more.",
